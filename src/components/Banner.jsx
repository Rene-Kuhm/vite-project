...
const Banner = () => {
  ...
  return (
    <section className='min-h-[85vh] lg:min-h-[78vh] m-12 flex items-center' id='home' ref={ref}>
      <div className='container mx-auto m-20'>
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          <div className={`flex-1 text-center font-secondary lg:text-left ${inView ? 'animate-fade-in-up' : ''}`}>
            ...
            <div className='mb-8 p-3 font-secondary font-semibold uppercase leading-[1]' style={{minHeight: '150px'}}>
          ...
          <div className={`hidden lg:flex flex-1 max-w-[320px] lg:max-w-[482px] ${inView ? 'animate-fade-in-down' : ''}`}>
